...
AAC_LIBRARY_PATH = Path(os.getenv("AAC_LIBRARY_PATH", BASE_DIR / "aac_library.csv"))
ORIGINAL_AAC_LIBRARY_PATH = Path(
    os.getenv("ORIGINAL_AAC_LIBRARY_PATH", BASE_DIR / "original_aac_library.csv")
)
EMBEDDING_PKL_PATH = Path(
    os.getenv("EMBEDDING_PKL_PATH", BASE_DIR / "library_vectors.pkl")
)
